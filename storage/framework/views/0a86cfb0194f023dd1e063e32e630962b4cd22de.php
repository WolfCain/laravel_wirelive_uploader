<form wire:submit.prevent="store" class="w-full max-w-sm" >
  <div class="flex items-center border-b border-indigo-500 py-2">
    <input wire:model="photo" id="<?php echo e($incurment); ?>" class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="file">
...
</form><?php /**PATH D:\xampp\htdocs\topvalue\resources\views/livewire/picture-create.blade.php ENDPATH**/ ?>